    ...
    <AnimatePresence mode="wait">
      ...
      >
        ...
        >
          ...
          <motion.button
            whileHover={{ scale: 1.01, boxShadow: "0 2px 8px rgba(16,185,129,0.10)" }}
            className="w-full flex justify-center items-center gap-2 bg-gradient-to-r from-green-500 to-green-700 text-white px-4 py-2 mt-6 text-sm rounded-lg cursor-pointer"
          >
