    ...
    <div className="h-full overscroll-y p-6 flex items-start flex-wrap gap-4 text-slate-70">
      ...
      <form onSubmit={(e) => {
        ...
        <div className="flex items-center gap-3">
          <Sparkles className="w-6 text-[#EA580C]"></Sparkles>
        ...
        <div className="mt-2 flex justify-center items-center w-full">
          <label htmlFor="dropzone-file" className="flex flex-col justify-center items-center w-full h-64 bg-gray-50 rounded-lg border-2 border-gray-300 border-dashed cursor-pointer hover:bg-gray-100">
            <div className="flex flex-col justify-center items-center pt-5 pb-6">
              ...
              <p className="text-xs text-gray-500">PNG, JPG, GIF and other image formats</p>
            </div>
            <input id="dropzone-file" type="file" className="hidden" onChange={(e) => setImage(e.target.files[0])} />
          </label>
        </div>

        <button className="w-full flex justify-center items-center gap-2 bg-gradient-to-r from-[#F97316] to-[#EA580C] text-white px-4 py-2 mt-6 text-sm rounded-lg cursor-pointer">
      ...
      <div className="w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200 flex flex-col min-h-96 max-h-[600px]">
        <div className="flex items-center gap-3">
          <Eraser className="w-6 text-[#EA580C]"></Eraser>
